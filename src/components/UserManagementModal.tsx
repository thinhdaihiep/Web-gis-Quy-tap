...
export const UserManagementModal: React.FC<UserManagementModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs z-[5000] flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[92vh] border border-slate-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Thiết lập tài khoản biên tập viên và phân quyền truy cập
              </p>
            </div>
          </div>
        ...
        {feedback && (
          <div
            className={`mx-5 mt-4 px-4 py-2.5 rounded-xl border flex items-center gap-2.5 text-xs font-semibold animate-in fade-in duration-150 ${
        ...
        {/* Content */}
        <div className="p-5 overflow-y-auto bg-white flex-1 flex flex-col gap-5">
          {/* Add User Form */}
            ...
            <form onSubmit={handleAddUser} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 items-end">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-medium focus:ring-2 focus:ring-blue-500 outline-none"
                  placeholder="ví dụ: Trần Quang Vinh"
                />
              </div>
        ...
        <div className="px-5 py-3 border-t border-slate-200 bg-slate-50 flex items-center justify-between shrink-0">
          <div className="text-xs text-slate-500 flex items-center gap-1.5">
            ...
            <span>Tổng số tài khoản: <strong>{users.length}</strong></span>
          </div>
          <button
            type="button"
            onClick={onClose}
